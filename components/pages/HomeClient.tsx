...
const subItems = [
  { icon: "/images/icons/zulu-beadwork-icon.png", key: "beadwork", img: "/images/zulu-beadwork-with-gogo-hluhluwe-kzn.jpg" },
  { icon: "/images/icons/zulu-dance-icon.png", key: "dance", img: "/images/zulu-traditional-dance-music-hluhluwe-kzn.jpg" },
  { icon: "/images/icons/zulu-spear-shield-icon.png", key: "spear", img: "/images/zulu-spear-shield-crafting-hluhluwe-kzn.jpg" },
  { icon: "/images/icons/zulu-cooking-icon.png", key: "cooking", img: "/images/traditional-zulu-cooking-experience-hluhluwe-kzn.jpg" },
];
  ...
  return (
    <div style={{ backgroundColor: "#e4ba78" }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden">
        <Image
          src="/images/mzamo-village-homestead-kraal-hero-hluhluwe-kzn.jpg"
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 py-28">
          ...
          {/* Exact required H1 text, kept visually consistent with the
              existing "Sawubona." brand greeting shown just above it. */}
          <motion.p
            variants={fadeUp}
            initial="hidden"
            animate="visible"
          ...
          >
            Mzamo&rsquo;s Cultural Village &amp; Homestead
          </motion.h1>
                ...
                {subItems.map(({ icon, key, img }) => (
                  ...
                  >
                    <div className="relative h-48 overflow-hidden">
                      <Image
                        src={img}
                        alt={t(`home.featured.culturalTour.items.${key}`)}
                        fill
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-black/20 flex flex-col justify-end p-5">
                      <div className="flex items-center gap-3">
                        <div className="relative w-8 h-8 flex-shrink-0 bg-white/90 rounded-full p-1.5 shadow-lg">
                          <Image src={icon} alt="" fill sizes="32px" className="object-contain p-0.5" aria-hidden="true" />
                        </div>
                        <span
          ...
          >
            <div className="relative overflow-hidden h-72 md:h-full min-h-[280px]">
              <Image
                ...
                alt="Traditional isiZulu hut accommodation at Mzamo's Cultural Village & Homestead, Hluhluwe"
                fill
            ...
            <div className="p-10 md:pr-14">
              ...
              <h2 className="text-3xl font-bold mb-4 text-zulu-brown-dark">
                {t("home.featured.accommodation.title")}
              </h2>
